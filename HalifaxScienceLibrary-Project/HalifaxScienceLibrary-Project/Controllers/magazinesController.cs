...
namespace HalifaxScienceLibrary_Project.Controllers
{
    public class magazinesController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            magazine magazine = await db.magazines.FindAsync(id);
            if (magazine == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create([Bind(Include = "C_id,name")] magazine magazine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "C_id,name")] magazine magazine)
        {
            if (ModelState.IsValid)
            {
